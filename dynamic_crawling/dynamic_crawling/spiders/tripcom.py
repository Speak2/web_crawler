                ...
                try:
                    ...
                    for index, city in enumerate(inbound_cities):
                        ...
                        if index < 3:
                            ...
                            h3_tag = 'Popular Cities in United Kingdom'
                    ...
                    for index, city in enumerate(outbound_cities):
                        ...
                        if index < 3:
                            h3_tag = 'Popular Hotels Worldwide'
                        else:
                            h3_tag = 'Popular Cities Worldwide'
                    ...
                    all_cities.append({
                        ...
                        'city_id': "-1",
                        'h3_tag': "Top Luxury 5-star Hotels"
                    })

                    all_cities.append({
                        'city_name': "cheapHotels",
                        'city_id': "-2",
                        'h3_tag': "Budget-friendly Hotels Worldwide"
                    })

                    all_cities.append({
                        'city_name': "hostelHotels",
                        'city_id': "-3",
                        'h3_tag': "Trending Guest Houses Worldwide"
                    })
                    ...
                    if selected_city_id in ["-1", "-2", "-3"]:
                        ...
                        for index, city in enumerate(hotel_list):
                            ...
                            img = city.get('imgUrl')
                            hotel_img_url = f"https://ak-d.tripcdn.com/images{
                        ...
                        new_url = f"https://uk.trip.com/hotels/list?city={
                            selected_city_id}&checkin={checkin_date}&checkout={checkout_date}"
            ...
            if match:
                ...
                try:
                    ...
                    for hotel in hotel_list:
                        ...
                        hotel_url = f"https://uk.trip.com/hotels/{
                            city_name}-hotel-detail-{hotel_id}/{hotel_ename}/"
    ...
    def save_image(self, response):
        try:
            ...
            try:
                ...
                self.logger.error(f"Failed to save image for {
                                  hotel_name}: {e}")
